...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
	...
	public void test_fahrenheitEnCelsius() {
        ...
        public void testCheck70fahtocelsius()
        {
            assertEquals("70 °F -> 21.1 °C ?", 21.1, question1.FahrenheitCelsius.fahrenheitEnCelsius(70), 0.1);
        }
        
         public void test50fahrenheitLessThan30celsius()
        {
            assertTrue("50°F < 30°C",question1.FahrenheitCelsius.fahrenheitEnCelsius(0) < 30);
        }
}
